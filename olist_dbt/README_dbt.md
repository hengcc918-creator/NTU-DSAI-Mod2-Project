...
2. Create new models for the dimension tables in the `models/star` directory. For example, create a `dim_customers.sql` file with the following SQL code to create the dim_customers model. Refer to the [dim_customers.sql](models/star/dim_customers.sql) file in the repository for the complete SQL code.
